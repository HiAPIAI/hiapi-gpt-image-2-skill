...
- Missing key: "Set `HIAPI_API_KEY` first. You can create a key at https://www.hiapi.ai/zh/register."
- Invalid key: "HiAPI rejected the API key. Check or regenerate it at https://www.hiapi.ai/zh/register."
